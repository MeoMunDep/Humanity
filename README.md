...
### 2. `addresses.txt` - 🗂️ User Data

- Wallets generator: [Link](https://github.com/MeoMunDep/Automatic-Ultimate-Create-Wallets-for-Airdrop)
- Add your wallet address in the following format:
...
- **Help me with your referral** [Referral Link](testnet.humanity.org/login?ref=meomundep)
